...
const brandImages = {
  gustoMain: "https://viomes.gr/images/homepage/brand/gusto_main.png",
  gustoSecondary: "https://viomes.gr/images/homepage/brand/gusto_secondary.png",
  verdiaLogo: "https://viomes.gr/images/homepage/brand/verdia_logo.png",
  kiklosLogo: "https://viomes.gr/images/homepage/brand/kiklos_logo.png",
  viomesSignature:
    "https://viomes.gr/images/homepage/brand/viomes_signature.png",
  cuboSet: "https://viomes.gr/images/homepage/brand/cubo_set.jpg",
  cuboCherry: "https://viomes.gr/images/homepage/brand/cubo_cherry.jpg",
  cuboBlack: "https://viomes.gr/images/homepage/brand/cubo_black.jpg",
};
...
const desktopVerdia = {
  ...
  gustoWordmark:
    "absolute left-[-2%] top-1/2 -translate-y-1/2 -rotate-90 font-bold leading-none tracking-[0.08em] text-[hsl(var(--viomes-light))]",
  logo: "absolute left-[52%] top-[60%] -translate-x-1/2 -translate-y-1/2",
  headline:
    "absolute left-[67%] top-[8%] z-30 w-[31%] font-medium leading-[1.04] tracking-tight text-[hsl(var(--viomes-light))] drop-shadow-[0_2px_8px_rgba(0,0,0,0.25)]",
  signature: "absolute left-[64%] top-[72%]",
  secondaryImage:
    "absolute right-[2%] top-[22%] h-[66%] w-[21%] overflow-hidden",
};

const desktopKiklos = {
  cuboSet: "absolute left-[1.35%] top-[8%] h-[80%] w-[24%] overflow-hidden",
  cuboWordmark:
    "absolute left-[15%] top-[19%] font-bold leading-none tracking-[0.03em] text-[hsl(var(--viomes-light))]",
...
const BrandCarouselControls = ({
  ...
  <div
    className={`z-40 flex items-center gap-2 border border-[hsl(var(--viomes-light))]/20 bg-[hsl(var(--viomes-dark))]/20 px-3 py-2 text-[hsl(var(--viomes-light))] shadow-lg shadow-[rgba(50,39,26,0.1)] backdrop-blur-sm ${className}`}
      ...
      return (
        <button
          ...
          className={`group flex items-center gap-2 px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] transition ${
            isActive
              ? "text-[hsl(var(--viomes-light))]"
              : "text-[hsl(var(--viomes-light))]/55 hover:text-[hsl(var(--viomes-light))]"
          }`}
        ...
        >
          <span
            className={`h-1.5 rounded-full transition-all duration-300 ${
              isActive
                ? "w-6 bg-[hsl(var(--viomes-light))]"
                : "w-1.5 bg-[hsl(var(--viomes-light))]/40 group-hover:bg-[hsl(var(--viomes-light))]/75"
            }`}
          />
    ...
    >
      <div className="hidden overflow-hidden lg:block">
        <div className="relative aspect-[4.08/1] w-full min-h-[260px] overflow-hidden bg-primary">
          <div
            className={`${desktopBaseCanvas} bg-viomes-dark ${
              activeSlide === 0
                ? "opacity-100"
          ...
          >
            ...
            <div
              className={desktopVerdia.gustoWordmark}
              style={{ fontSize: "var(--type-brand-wordmark-verdia)" }}
            >
              GUSTO
            </div>
            ...
            <p
              className={desktopVerdia.headline}
              style={{ fontSize: "var(--type-brand-headline)" }}
            >
              <span className="block">Προϊόντα με</span>
              <span className="block">σύγχρονη</span>
              <span className="block">αισθητική</span>
            </p>
          ...
          <div
            className={`${desktopBaseCanvas} bg-accent ${
              activeSlide === 1
                ? "opacity-100"
                : "pointer-events-none opacity-0"
            }`}
          ...
          >
            ...
            <div
              className={desktopKiklos.cuboWordmark}
              style={{ fontSize: "var(--type-brand-wordmark-kiklos)" }}
            >
              CUBO
            </div>
      ...
      <div className="lg:hidden">
        <div className="grid gap-6 bg-accent px-5 py-8 sm:px-8 sm:py-10">
          <div className="grid gap-4 sm:grid-cols-[1.15fr_0.85fr] sm:items-center">
            <div className="relative overflow-hidden">
              <img
                src={
                  activeSlide === 0
                    ? brandImages.gustoMain
                    : brandImages.cuboSet
                }
                alt={
                  activeSlide === 0
                    ? "GUSTO collection tableware"
                    : "CUBO recycling bins in color"
                }
            ...
            <div className="flex flex-col items-start gap-5 sm:items-center">
              <img
                src={
                  activeSlide === 0
                    ? brandImages.verdiaLogo
                    : brandImages.kiklosLogo
                }
              ...
              <p className="max-w-sm text-3xl font-medium leading-[1.05] tracking-tight text-white sm:text-center sm:text-4xl">
                {activeSlide === 0
                  ...
                  : "Σχεδιασμός για καθαρότερους χώρους"}
              </p>
              <img
                src={brandImages.viomesSignature}
                alt="Designed and manufactured by VIOMES"
          ...
          <img
            src={
              activeSlide === 0
                ? brandImages.gustoSecondary
                : brandImages.cuboBlack
            }
            alt={
              activeSlide === 0
                ? "GUSTO plate detail"
                : "Black CUBO recycling bin"
            }
