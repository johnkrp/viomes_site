...
const Home = () => {
  ...
  return (
    <div className="flex flex-col">
      <section className={heroComposition.canvas} aria-label="VIOMES homepage hero">
        <div className="hidden lg:block">
          <div className={heroComposition.content}>
            <div className={heroComposition.accentFrame} />
            <div className={heroComposition.textBlock}>
              <p className={heroComposition.eyebrow}>VIOMES S.A.</p>
              <h1 className={heroComposition.heading}>Προϊόντα για κάθε χώρο</h1>
              <p className={heroComposition.description}>
