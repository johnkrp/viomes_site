  ...
  const timeline = [
    {
      year: "1978",
      title: "Ίδρυση",
      desc: "Η VIOMES ξεκινά την πορεία της στην Αθήνα, εστιάζοντας σε βασικά οικιακά είδη.",
    },
    {
      year: "1995",
      title: "Νέες Εγκαταστάσεις",
      desc: "Μεταφορά σε ιδιόκτητες εγκαταστάσεις στα Οινόφυτα και επέκταση της παραγωγής.",
    },
    {
      year: "2008",
      title: "Τεχνολογική Αναβάθμιση",
      desc: "Επένδυση σε υπερσύγχρονες μηχανές injection και αυτοματισμούς.",
    },
    {
      year: "2018",
      title: "Εξαγωγικό Άνοιγμα",
      desc: "Δυναμική παρουσία σε διεθνείς αγορές της Ευρώπης και της Μέσης Ανατολής.",
    },
    {
      year: "2024",
      title: "Σήμερα",
      desc: "Κορυφαία εταιρεία στον κλάδο των πλαστικών με έμφαση στην κυκλική οικονομία.",
    },
  ];
    ...
    <div className="pt-32 md:pt-36 min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative">
              <div className="rounded-3xl overflow-hidden aspect-square shadow-2xl">
                <img
                  src="https://images.unsplash.com/photo-1530124560676-4fbc91abc6f2?auto=format&fit=crop&q=80&w=800"
                  alt="Innovation"
                  className="w-full h-full object-cover"
                  loading="lazy"
                  decoding="async"
      ...
      <section className="py-20 bg-accent overflow-hidden relative">
        ...
        <div className="container mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 text-white">
          ...
          <Button
            size="lg"
            className="bg-white text-accent hover:bg-white/90 rounded-full px-12 h-16 text-lg font-bold group"
          >
