        ...
        <div className="relative container mx-auto px-6 py-14 md:py-20">
          <Breadcrumb className="text-sm text-white/80">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Γλάστρες</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          ...
          <p className="mt-5 max-w-2xl text-base leading-relaxed text-white/90 md:text-lg">
            Σειρές γλαστρών και ζαρντινιερών με έμφαση στη μορφή, την αντοχή
            στον χρόνο και την καθαρή αισθητική για εσωτερικούς και εξωτερικούς
            χώρους.
          </p>
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          <div>
            ...
            <p className="mt-4 max-w-xl text-sm leading-relaxed text-foreground/75 md:text-base">
              Από μικρές εφαρμογές τοίχου μέχρι μεγάλες ζαρντινιέρες, η σειρά
              οργανώνεται σε καθαρές ενότητες για γρήγορη επιλογή.
            </p>
          </div>

          <div className="grid grid-cols-1 gap-y-2 border-l border-black/15 pl-5 sm:gap-y-3 md:pl-7">
            {PLANTERS_SUBCATEGORIES.map((subcategory) => (
              <p
                key={subcategory}
                className="text-sm font-medium leading-relaxed text-[#2f3f33] md:text-base"
              >
                {subcategory}
              </p>
            ))}
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col justify-center">
                  <h3 className="text-2xl font-semibold leading-tight text-[#1f2f23] md:text-3xl">
                    {product.title}
                  </h3>
...
export default CategoryPlanters;
